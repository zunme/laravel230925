                ...
                <div class="datatable-table1 table-length-hide table-filter-hide">
                    <form id="form_dist_search" @submit=${prevent}>
                        <div class="tw-flex tw-gap-5 tw-justify-end newsearchwrap tw-border-init">
							<div class="relative">
								<div class="floating-label absolute">등록일</div>
								<input 
								class="tw-cal tw-bg-gray-300/50 tw-border tw-border-gray-300 
									tw-text-gray-900 tw-text-sm tw-rounded-lg tw-block tw-min-w-[100px] tw-px-[10px] tw-py-[6px]" 
								type="date" 
								name="created_at" 
								placeholder="등록일"
								@change=${redraw}
                            ...
                            <div  class="tw-flex tw-gap-2 tw-pl-[5px]">
                                ...
                                tw-text-gray-900 tw-text-sm tw-rounded-lg tw-block tw-w-full tw-px-[10px] tw-py-[6px]" name="searchtype">
                                    ...
                                    <option value="users.name">이름</option>
                                    <option value="users.tel">전화번호</option>
                                </select>
                                <input 
