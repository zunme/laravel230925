@php
	...
	$assets_version = '20231005102501';
	$url_prefix="/partner";
	$nowtime = \Carbon\Carbon::now()->format('YmdHis');
@endphp
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
	  ...
	  style="
				...
				/*--f7-navbar-bg-color-rgb : var(--f7-theme-color-rgb);*/
			 	--f7-navbar-bg-color-rgb : 41 ,143, 255;
...
>
    ...
    @endif
		...
		<link rel="stylesheet" href="/css/default.css?ver={{$assets_version}}">
		<style>
			html{
    ...
    <body class="base">
		...
		<script>
			...
			var routes = [
				{
					path: '/',
					componentUrl: '{{$url_prefix}}/pages/home',
				...
				},
				{
					...
					componentUrl: '{{$url_prefix}}/pages/login',
					//beforeEnter:[checkAuth],
					name: 'login',
				},
			];
		...
		<script src="/js/appinit.js?ver={{$assets_version}}" defer></script>
	</body>
</html>
