    ...
    <body>
					...
					<div class="page">
						<div class="toolbar toolbar-bottom" style="--f7-toolbar-height: 46px;">
							<div class="toolbar-inner">
								<a href="#" class="link tw-grow" onClick="logoutPartner()">로그아웃</a>
							</div>
						</div>
						<div class="page-content tw-bg-gray-100 tw-text-black">
							<div class="list accordion-list leftmenu">
								<ul class="custom-menu-list">
									...
									<li class="links-list">
										<a href="/partner/{{$menuitem['url']}}" class="panel-close">{{$menuitem['title']}}</a>
									</li>
									@endforeach
								</ul>
							</div>
		...
		<script>
			...
			var routes = [
				{
					path: '/partner',
					componentUrl: '/partner/pages/home',
					//beforeEnter:[checkAuth],
					name: 'home',
				},
				//기본팝업
				{
					path: '/partner/popup/:type',
					popup: {
						closeByBackdropClick : true,
						componentUrl: '/partner/popup/view/{{type}}' ,
					},
				},
				{
					path: '/partner/popup/:type/:id',
					popup: {
						closeByBackdropClick : true,
						componentUrl: '/partner/popup/view/{{type}}' ,
					},
				...
				{
					path: '/partner/popup/:type/:id/:subid',
					popup: {
						closeByBackdropClick : true,
						componentUrl: '/partner/popup/view/{{type}}' ,
					},
